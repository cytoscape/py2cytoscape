...
class layout(object):
    ...
    def copycat(self, gridUnmapped=None, selectUnmapped=None, sourceColumn=None,
        ...
        :param targetNetwork (string): The name of the network to apply coordinates
                        to.
        """
        PARAMS = set_param(['gridUnmapped', 'selectUnmapped', 'sourceColumn', 'sourceNetwork', 'targetColumn', 'targetNetwork'], [
                           gridUnmapped, selectUnmapped, sourceColumn, sourceNetwork, targetColumn, targetNetwork])
    ...
    def genemania_force_directed(self, curveSteepness=None, defaultEdgeWeight=None,
        ...
        """
        network = check_network(self, network, verbose=verbose)
        PARAMS = set_param(['curveSteepness',
                            'defaultEdgeWeight',
    ...
    def isom(self, coolingFactor=None, EdgeAttribute=None, initialAdaptation=None,
        ...
        """
        network = check_network(self, network, verbose=verbose)
        PARAMS = set_param(['coolingFactor',
                            'EdgeAttribute',
                            'initialAdaptation',
                            'maxEpoch',
                            'minAdaptation',
